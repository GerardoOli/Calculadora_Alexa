...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hola, bienvenido a la calculadora de Gerardo';
...
const sumalntent = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'sumalntent';
    },
    handle(handlerInput) {
...
const divisionIntent = {
    ...
    handle(handlerInput) {
        const cantidad1 = handlerInput.requestEnvelope.request.intent.slots.uno.value;
        const cantidad2 = handlerInput.requestEnvelope.request.intent.slots.dos.value;
        console.log(`Valor del slot uno: ${cantidad1}`);
        console.log(`Valor del slot dos: ${cantidad2}`);
        const numero1 = Number(cantidad1);
        const numero2 = Number(cantidad2);
...
const logaritmoIntent = {
    ...
    handle(handlerInput) {
        ...
        if (isNaN(numero) || numero <= 0) {
            return handlerInput.responseBuilder
                .speak('Lo siento, no pude entender el número o el número no es válido para calcular el logaritmo. Por favor, inténtalo de nuevo.')
                .getResponse();
        }
...
const potenciaIntent = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `El resultado de elevar ${numeroBase} a la potencia de ${numeroExponente} es igual a ${resultado}.`;
